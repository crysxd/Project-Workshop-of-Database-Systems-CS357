...
$.rest.post = function(url, params, callback, data) {
  $.rest.send(url + '?' + $.param(params), 'POST', typeof data !== 'string' ? JSON.stringify(data) : data, callback);
...
$.rest.put = function(url, params, callback, data) {
  $.rest.send(url + '?' + $.param(params), 'PUT', typeof data !== 'string' ? JSON.stringify(data) : data, callback);
